    ...
    .directive('resizable', function() {
        ...
        return {
            ...
            link: function(scope, element, attr) {
                scope.maxTrackPix = parseInt(window.getComputedStyle(element[0].parentElement, null).width.slice(0,-2));
                element[0].style['flex-basis'] = (scope.maxTrackPix*scope.workoutLen)/scope.mixLength + 'px';
                ...
                var dragging = function(e) {
                    ...
                    switch(dragDir) {
                        ...
                        case 'right':
                            ...
                            var oldWidth = parseInt(element[0].style[prop].slice(0,-1));
